...
export default async function Layout({
	...
	const links = [
		{ name: "Dashboard", href: "/master-franchise/dashboard" },
		{ name: "profile", href: "/master-franchise/profile" },
	];

	return (
		<WithRole allowedRole={FranchiseType.MASTER_FRANCHISE} session={session}>
