	...
	return (
		<div>
			...
			<p>
				...
				franchise operations, including creating and managing chapters
				franchises. Use the link above to navigate to different sections of the
				admin panel.
			</p>
		</div>
	);
